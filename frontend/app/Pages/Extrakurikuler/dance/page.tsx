...
export default function DanceDetail() {
  const benefits = [
    "Pengembangan kreativitas dan ekspresi diri melalui tarian",
    "Latihan koordinasi, fleksibilitas, dan kebugaran fisik",
    "Peningkatan rasa percaya diri dan kemampuan tampil di depan umum",
    "Pelatihan disiplin dan konsistensi melalui latihan rutin",
    "Pembelajaran kerja sama tim dan harmoni dalam kelompok"
  ];


  const activities = [
    { name: "Latihan Dasar Tari", description: "Menguasai gerakan dasar dan teknik tari" },
    { name: "Koreografi", description: "Belajar menyusun rangkaian gerakan menjadi sebuah tarian" },
    { name: "Ekspresi dan Improvisasi", description: "Mengembangkan kreativitas dan ekspresi diri melalui gerakan" },
    { name: "Kedisiplinan Latihan", description: "Melatih konsistensi dan fokus melalui latihan rutin" },
    { name: "Penampilan dan Pertunjukan", description: "Pengalaman tampil di panggung dan kompetisi" },
    { name: "Kerja Sama Tim", description: "Latihan koordinasi dan harmoni dalam kelompok" }
  ];
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-8">
              ...
              <div className="space-y-4 text-gray-700">
                <p>
                  Ekstrakurikuler Dance merupakan kegiatan pendidikan seni yang bertujuan mengembangkan kreativitas, ekspresi diri, dan keterampilan siswa melalui metode pembelajaran yang menyenangkan dan menantang.
                </p>
                <p>
                  Program ini menerapkan sistem latihan dance yang terbukti efektif dalam mengembangkan kreativitas, disiplin, dan rasa tanggung jawab pada generasi muda.
                </p>
              </div>
            </div>
