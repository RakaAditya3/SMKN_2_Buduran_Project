...
export default function BanjariDetail() {
  const benefits = [
  "Pengembangan kemampuan musik dan ritme",
  "Latihan koordinasi tangan dan kekompakan kelompok",
  "Peningkatan kreativitas dan ekspresi diri",
  "Pelatihan disiplin melalui latihan rutin",
  "Penanaman apresiasi seni tradisi dan budaya"
];


  const activities = [
  { name: "Latihan Ritme Dasar", description: "Mempelajari pola ketukan dan tempo musik" },
  { name: "Teknik Memukul", description: "Melatih teknik memukul gendang dan alat musik perkusi" },
  { name: "Koordinasi dan Harmoni", description: "Berlatih sinkronisasi antaranggota dalam kelompok" },
  { name: "Kreativitas dan Improvisasi", description: "Mengembangkan kreativitas dalam menciptakan variasi musik" },
  { name: "Pertunjukan Musik", description: "Pengalaman tampil di acara sekolah dan lomba" },
  { name: "Apresiasi Budaya", description: "Mempelajari sejarah dan nilai seni musik tradisional" }
];
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-8">
              ...
              <div className="space-y-4 text-gray-700">
                <p>
                  Ekstrakurikuler Banjari merupakan kegiatan pendidikan musik yang bertujuan mengembangkan kemampuan bermusik, kreativitas, dan keterampilan siswa melalui metode pembelajaran yang menyenangkan dan menantang.
                </p>
                <p>
                  Program ini menerapkan sistem latihan musik Banjari yang terbukti efektif dalam mengembangkan keterampilan bermusik, disiplin, dan rasa tanggung jawab pada generasi muda.
                </p>
              </div>
            </div>
