...
export default function PramukaDetail() {
  const benefits = [
  "Pengembangan keterampilan teknik dan strategi bermain badminton",
  "Peningkatan kebugaran, kecepatan, dan refleks",
  "Latihan disiplin dan konsistensi melalui latihan rutin",
  "Pengembangan kerja sama tim dan sportivitas",
  "Penanaman semangat kompetitif dan fair play"
];


  const activities = [
  { name: "Latihan Teknik Dasar", description: "Menguasai pukulan dasar seperti smash, drop, dan clear" },
  { name: "Strategi dan Taktik", description: "Belajar pola permainan dan strategi bertanding" },
  { name: "Latihan Fisik dan Refleks", description: "Meningkatkan kebugaran, kecepatan, dan koordinasi" },
  { name: "Permainan Latihan", description: "Simulasi pertandingan dan latihan sparring" },
  { name: "Kerja Sama Tim", description: "Melatih komunikasi dan koordinasi dalam ganda atau beregu" },
  { name: "Turnamen dan Kompetisi", description: "Pengalaman bertanding di turnamen internal maupun eksternal" }
];
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-8">
              ...
              <div className="space-y-4 text-gray-700">
                <p>
                  Ekstrakurikuler Badminton merupakan kegiatan olahraga yang bertujuan mengembangkan keterampilan bermain, strategi, dan kebugaran siswa melalui latihan yang menyenangkan dan menantang.
                </p>
                <p>
                  Program ini menerapkan sistem latihan badminton yang terbukti efektif dalam mengembangkan keterampilan bermain, disiplin, dan rasa tanggung jawab pada generasi muda.
                </p>
              </div>
            </div>
